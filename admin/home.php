        ...
        <div class="overview-boxes">
            <div class="box">
                <div class="right-side">
                    ...
                    <div class="number"> <?php while($user = mysqli_fetch_array($exe1)) echo $user['u'] ?> </div>
                    <div class="indicator">
            ...
            <div class="box">
                <div class="right-side">
                    ...
                    <div class="number"> <?php while($user = mysqli_fetch_array($exe2)) echo $user['p'] ?> </div>
                    <div class="indicator">
                        <i class='bx bx-up-arrow-alt'></i>
                        <span class="text">Up to date</span>
                    </div>
            ...
            <div class="box">
                <div class="right-side">
                    ...
                    <div class="number">
                        <?php while($user = mysqli_fetch_array($exe3)) echo $user['e'] ?>
                    </div>
                    <div class="indicator">
                        <i class='bx bx-up-arrow-alt'></i>
                        <span class="text">Up to date</span>
            ...
            <div class="box">
                <div class="right-side">
                    ...
                    <div class="number">
                        <?php while($user = mysqli_fetch_array($exe4)) echo $user['a'] ?>
                    </div>
                    <div class="indicator">
                        <i class='bx bx-up-arrow-alt'></i>
                        <span class="text">Up to date</span>
